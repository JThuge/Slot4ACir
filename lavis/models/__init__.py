...
from lavis.models.blip2_models.blip2_light_cir import Blip2LightCir
...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu", light_model_name="efficientnet-b0", use_adapt=False, num_slots=8, loss_setting=["itc", "dta"]):
    """
    ...
    # load model
    model = model_cls.from_pretrained(model_type=model_type, light_model_name=light_model_name, use_adapt=use_adapt, num_slots=num_slots, loss_setting=loss_setting)
