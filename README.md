...
```
### Prepare Datasets
We have uploaded all used datasets to [Google Drive](https://drive.google.com/drive/folders/1sM3ybF7H6G46sKDkSrcVks6yH4yPkwMx), which includes the original CIRR and FashionIQ dataset, as well as additional text data generated by the LLM sampler. Unzip and organize them in your dataset root folder as follows:
```
|-- YOUR_DATA_ROOT
   |-- CIRR
      |-- cirr
